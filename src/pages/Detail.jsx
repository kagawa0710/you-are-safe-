...
export default function Detail() {
  ...
  return (
      ...
      >
        ...
        <Image src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7br1bzBVg6pxikOK5YVMZA4zHcez6RXXWyg&usqp=CAU"
               alt="防災訓練" objectFit="cover" height="300px"/>
        <Box p="4">
          ...
          <Text
              mb="4">説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります説明が入ります。</Text>
          <Divider my="4"/>
          <Box>
